...
description: >-
  ...
  Cargo/workspace root) linking pr402, on-chain rails, oracle-qa, starters, and
  paid-service examples. Use when navigating this repo, explaining ecosystem
  layout, locating project folders, or choosing which codebase to edit.
...
| `oracle-qa/` | Reference oracle server (Rust/Axum) for SLA-Escrow |
